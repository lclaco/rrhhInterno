...
ActiveRecord::Schema[7.0].define(version: 2023_08_05_070001) do
  ...
  create_table "job_offers", force: :cascade do |t|
    ...
    t.index ["created_by_id"], name: "index_job_offers_on_created_by_id"
  end
  ...
  add_foreign_key "job_offers", "users", column: "created_by_id"
end
